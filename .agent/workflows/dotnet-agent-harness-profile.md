---
description: >-
  Analyze skill performance locally. Measure load time, execution duration, and
  resource usage without telemetry.
trigger: /dotnet-agent-harness-profile
turbo: true
---
# Workflow: /dotnet-agent-harness-profile
