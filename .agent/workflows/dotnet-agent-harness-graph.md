---
description: >-
  Generate dependency graphs for skills. Visualize skill relationships,
  cross-references, and usage patterns as Mermaid diagrams.
trigger: /dotnet-agent-harness-graph
turbo: true
---
# Workflow: /dotnet-agent-harness-graph
