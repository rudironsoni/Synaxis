...
namespace Synaxis.Shared.Kernel.Infrastructure.Services
{
    ...
    public class TenantService : ITenantService
    {
        ...
        public async Task<OrganizationLimits> GetOrganizationLimitsAsync(Guid organizationId)
        {
            ...
            ApplyOrganizationOverrides(organization, limits);

            return limits;
        }

        private static OrganizationLimits GetPlanLimits(SubscriptionPlan? plan)
        {
        ...
        private static void ApplyOrganizationOverrides(Organization organization, OrganizationLimits limits)
        {
        ...
        private static T GetLimitValue<T>(IDictionary<string, object> config, string key, T defaultValue)
        {
