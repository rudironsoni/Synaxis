...
namespace Synaxis.Shared.Kernel.Infrastructure.Data.Migrations
{
    ...
    partial class SynaxisDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.CreditTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.Invitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.JwtBlacklist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("jwt_blacklists", (string)null);
                });
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.Organization", b =>
                {
                    ...
                    b.ToTable("organizations", null, t =>
                        {
                            t.HasCheckConstraint("CK_Organization_Slug_Lowercase", "slug ~ '^[a-z0-9]+(-[a-z0-9]+)*$'");
                        });
                });

            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.OrganizationApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("organization_api_keys", (string)null);
                });

            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.PasswordHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.PasswordPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.SpendLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.TeamMembership", b =>
                {
                    ...
                    b.ToTable("team_memberships", null, t =>
                        {
                            t.HasCheckConstraint("CK_TeamMembership_Role_Valid", "role IN ('OrgAdmin', 'TeamAdmin', 'Member', 'Viewer')");
                        });
                });
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.AuditLog", b =>
                {
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.Organization", "Organization")
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.Collection", b =>
                {
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.User", "Creator")
                        .WithMany()
                    ...
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.Team", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.CollectionMembership", b =>
                {
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.User", "Adder")
                        .WithMany()
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.Collection", "Collection")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.ConversationTurn", b =>
                {
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.Conversation", "Conversation")
                        .WithMany("Turns")
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.Invitation", b =>
                {
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.User", "Inviter")
                        .WithMany()
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.PasswordPolicy", b =>
                {
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.Organization", "Organization")
                        ...
                        .HasForeignKey("Synaxis.Shared.Kernel.Domain.Models.PasswordPolicy", "OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Synaxis.Shared.Kernel.Domain.Models.Request", b =>
                {
                    ...
                    b.HasOne("Synaxis.Shared.Kernel.Domain.Models.VirtualKey", "VirtualKey")
                        .WithMany("Requests")
