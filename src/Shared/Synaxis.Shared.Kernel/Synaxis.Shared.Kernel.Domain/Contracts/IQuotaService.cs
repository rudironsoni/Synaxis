...
namespace Synaxis.Shared.Kernel.Domain.Contracts
{
    ...
    public class QuotaCheckRequest
    {
        ...
        /// </summary>
        public required string TimeGranularity { get; set; }
    ...
    public class UsageReport
    {
        ...
        /// </summary>
        public required IDictionary<string, long> UsageByMetric { get; set; }

        /// <summary>
        /// Gets or sets usage grouped by model.
        /// </summary>
        public required IDictionary<string, long> UsageByModel { get; set; }
