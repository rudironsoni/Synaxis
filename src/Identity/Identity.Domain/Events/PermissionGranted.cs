// <copyright file="PermissionGranted.cs" company="Synaxis">
...
/// <summary>
/// Event raised when a permission is granted to a user or role.
/// </summary>
public sealed record PermissionGranted : IDomainEvent, INotification
{
    /// <inheritdoc/>
    ...
    /// <summary>
    /// Gets the identifier of the user who granted the permission.
    /// </summary>
