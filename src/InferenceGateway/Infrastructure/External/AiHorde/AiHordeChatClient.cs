...
public class AiHordeChatClient : IChatClient
{
    ...
    private class GenerateResponse { [JsonPropertyName("id")] public string? Id { get; set; } }
    private class StatusResponse { [JsonPropertyName("done")] public bool Done { get; set; } [JsonPropertyName("text")] public string? Text { get; set; } }
}
