// <copyright file="ControlPlaneDbContext.cs" company="PlaceholderCompany">
...
namespace Synaxis.InferenceGateway.Infrastructure.ControlPlane
{
    ...
    public class ControlPlaneDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            ConfigureAuditSchema(modelBuilder, isPostgreSql);
        }
        ...
        private static void ConfigureAuditSchema(ModelBuilder modelBuilder, bool isPostgreSql)
        {
