...
namespace Synaxis.InferenceGateway.WebApi.Middleware
{
    ...
    public sealed class RegionRoutingMiddleware
    {
        ...
        /// <param name="regionRouter">The region router service.</param>
            ...
            IGeoIPService geoIPService)
        {
            try
            {
                ...
                context.Response.OnStarting(() =>
                {
                    ...
                    context.Response.Headers["X-Cross-Border"] = (!string.Equals(currentRegion, userRegion, StringComparison.Ordinal)).ToString(System.Globalization.CultureInfo.InvariantCulture);
