...
namespace ContextSavvy.LlmProviders.Infrastructure.Providers.Tier1
{
    ...
    /// </summary>
    public class CloudflareProvider : ILlmProvider
    {
            ...
            IConfiguration config)
        {
            ...
            _accountId = config["Cloudflare:AccountId"] ?? Environment.GetEnvironmentVariable("CLOUDFLARE_ACCOUNT_ID");
            _apiToken = config["Cloudflare:ApiToken"] ?? Environment.GetEnvironmentVariable("CLOUDFLARE_API_TOKEN");
        }
