...
public class LlmGrpcService : LlmService.LlmServiceBase
{
        ...
        ServerCallContext context)
    {
        ...
        var messages = request.Messages.Select(m => new ContextSavvy.LlmProviders.Application.Dtos.ChatMessage(m.Role, m.Content)).ToArray();
