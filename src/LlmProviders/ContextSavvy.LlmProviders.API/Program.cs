...
using Ghostwright.Infrastructure;
using Ghostwright.Infrastructure.Providers;
using Ghostwright.Infrastructure.Selectors;
...
builder.Services.AddGhostwright(builder.Configuration);
