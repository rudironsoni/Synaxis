...
namespace Synaxis.Routing.SmartRouter
{
    ...
    public class ProviderPerformanceTracker
    {
        ...
        {
            this._metrics = new ConcurrentDictionary<string, ProviderPerformanceMetrics>(StringComparer.OrdinalIgnoreCase);
            this._latencyHistory = new ConcurrentDictionary<string, List<int>>(StringComparer.OrdinalIgnoreCase);
            this._requestTimestamps = new ConcurrentDictionary<string, List<DateTime>>(StringComparer.OrdinalIgnoreCase);
        }
        ...
        {
            return this._metrics.ToDictionary(kvp => kvp.Key, kvp => kvp.Value, StringComparer.OrdinalIgnoreCase);
        }
