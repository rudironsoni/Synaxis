// <copyright file="RoutingPredictor.cs" company="Synaxis">
    ...
    public class RoutingPredictor
{
        ...
        ProviderPerformanceTracker? performanceTracker = null)
    {
        ...
        this._providerWeights = new ConcurrentDictionary<string, double>(StringComparer.OrdinalIgnoreCase);
    }
    ...
    {
        return this._providerWeights.ToDictionary(kvp => kvp.Key, kvp => kvp.Value, StringComparer.OrdinalIgnoreCase);
    }
