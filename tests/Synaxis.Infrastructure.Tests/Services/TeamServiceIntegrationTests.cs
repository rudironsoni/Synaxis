...
namespace Synaxis.Infrastructure.Tests.Services
{
    ...
    public class TeamServiceIntegrationTests : IAsyncLifetime
    {
        ...
        public async Task ListTeams_ExcludesSoftDeletedTeams()
        {
            ...
            teams.Teams.First().Id.Should().Be(team2.Id);
        }
