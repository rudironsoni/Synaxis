...
{
    #region ParseAsync - Null and Empty Input Tests
    ...
    #region ParseAsync - Valid JSON Tests
    ...
    #region ParseAsync - Invalid JSON Tests
    ...
    #region ParseAsync - Message Format Tests
    ...
    #region ParseAsync - Body Size Limit Tests
    ...
    public async Task ParseAsync_WithContentLengthExceedingDefaultLimit_ThrowsBadHttpRequestException()
    {
        ...
        var exception = await Assert.ThrowsAsync<BadHttpRequestException>(
            () => OpenAIRequestParser.ParseAsync(context));
        Assert.Contains("Request body too large", exception.Message);
    }
    ...
    #region ParseAsync - Configuration Tests
    ...
    #region ParseAsync - Request Body Rewind Tests
