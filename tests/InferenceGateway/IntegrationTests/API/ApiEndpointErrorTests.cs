// <copyright file="ApiEndpointErrorTests.cs" company="PlaceholderCompany">
...
(StringComparer.Ordinal)
    ...
    public async Task Post_ChatCompletions_InvalidModelId_Returns400()
    {
        ...
        Assert.Contains("no providers available", content.ToLowerInvariant(), StringComparison.Ordinal);
    }
    ...
    public async Task Post_ChatCompletions_MissingMessagesField_Returns200()
    {
        ...
        Assert.Equal(HttpStatusCode.BadRequest, response.StatusCode);
        Assert.Contains("At least one message is required", content, StringComparison.Ordinal);
    }
    ...
    public async Task Post_ChatCompletions_InvalidMessageFormat_MissingRole_Returns400()
    {
        ...
        Assert.Contains("Message role is required", content, StringComparison.Ordinal);
    }
...
public class MockProviderRegistry : IProviderRegistry
{
    ...
    {
        if (string.Equals(modelId, "model", StringComparison.Ordinal) || string.Equals(modelId, "no-stream", StringComparison.Ordinal))
        {
    ...
    {
        if (string.Equals(serviceKey, "test-provider", StringComparison.Ordinal))
        {
