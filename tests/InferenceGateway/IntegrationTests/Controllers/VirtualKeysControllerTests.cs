// <copyright file="VirtualKeysControllerTests.cs" company="Synaxis">
...
namespace Synaxis.InferenceGateway.IntegrationTests.Controllers
{
    ...
    public class VirtualKeysControllerTests : IClassFixture<SynaxisWebApplicationFactory>
    {
        ...
        public VirtualKeysControllerTests(SynaxisWebApplicationFactory factory, ITestOutputHelper output)
        {
