...
/// </summary>
public class MockHttpHandler(MockProviderResponses? responses = null) : HttpMessageHandler
{
    private readonly MockProviderResponses _responses = responses ?? new MockProviderResponses();
