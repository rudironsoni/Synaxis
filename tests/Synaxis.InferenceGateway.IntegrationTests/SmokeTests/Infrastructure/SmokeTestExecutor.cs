...
public class SmokeTestExecutor(HttpClient httpClient, SmokeTestOptions options, ITestOutputHelper output)
{
    private readonly HttpClient _httpClient = httpClient ?? throw new ArgumentNullException(nameof(httpClient));
    private readonly SmokeTestOptions _options = options ?? throw new ArgumentNullException(nameof(options));
