...
description: >-
  Generates documentation for .NET projects. Analyzes project structure,
  recommends doc tooling, generates Mermaid architecture diagrams, writes XML
  doc comment skeletons, and scaffolds GitHub-native docs. Triggers on: generate
  docs, add documentation, create README, document this project, add XML docs,
